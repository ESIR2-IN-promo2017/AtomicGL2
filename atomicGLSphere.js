...
atomicGLSphere = function(nname,rradius, llatitudeBands,llongitudeBands){
	// attributes
	// -------------------------------------------------
	// name
	this.name = nname ;
	...
	for (var latNumber=0; latNumber <= this.latitudeBands; latNumber++) {
            ...
            for (var longNumber = 0; longNumber <= this.longitudeBands; longNumber++) {
                ...
                this.colorsArray.push(0.8);
                // uv
                this.textureCoordsArray.push(longNumber/this.longitudeBands);
                this.textureCoordsArray.push(latNumber/this.latitudeBands);              
            }
        }
...
//    this.SphereVertexTexCoordBufferNumItems 	= this.textureCoordsArray/2 ;
	this.SphereVertexColorBufferNumItems 		= this.colorsArray /3 ;
